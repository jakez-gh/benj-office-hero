...
Office Hero shows you your daily route and lets you track progress as you complete jobs. This guide covers viewing your route, marking stops complete, and using the mobile/web app.

---

## Accessing Your Route

### Via Tech-Web (Desktop/Laptop)

1. Visit `https://tech.officehero.dev`
2. Login with your email and password
3. Click **"My Route Today"**
4. Your daily route appears with all stops

### Via Tech-Mobile (Android)

1. Open the Office Hero app
2. Tap **"Authenticate"** (first time only)
3. Login with your credentials
4. You'll see today's route automatically

### Via iPhone (Coming Soon)

iOS app launching Q3 2026.
...
Stop 3: 789 Pine Rd (pending)
  Job: Electrical inspection
  ETA: 10:45
  Time window: 10:30 - 11:30
```
...
4. Check the time window for customer availability
4. Verify vehicle and crew info
...
4. Your manager can now track your location

### 3. Heading to First Stop

1. Use **"Directions"** in the app to get turn-by-turn nav
2. App shows estimated arrival time
3. Manager can see your real-time location
...
2. Enter reason:
   ...
   - "Requires parts - backorder"
   - "Access denied"
   - "Other"
3. Click **"Skip"**
4. Job returns to pending (manager re-dispatches later)
...
3. Click **"Directions"** to start navigation
...
4. Focus on quality work, not speed
...
- Ask customer questions if unsure
...
- Report problems immediately, don't delay
...
|---------|--------------|
| **My Route** | See all today's stops and status |
| **Directions** | Turn-by-turn navigation to each stop |
| **Stop Details** | Job info, customer contact, notes |
| **Mark Arrived** | Confirm arrival at customer location |
| **Mark Complete** | Confirm work is finished |
| **Skip Stop** | Mark stop as unable to complete |
| **Route Chat** | Message manager or other crew |
| **Docs** | View photos or files for the job |
...
- Privacy: Only visible to your manager

You can't disable location (it's required for dispatch to work), but you can disable app notifications if they're distracting.
...
- Plug in when you get back to vehicle

---

## Tech-Web

If you prefer desktop or want a larger screen:
...
4. Call manager to confirm if unsure

### "Technician tracking showing wrong location"
...
2. Wait 10 seconds
3. Reopen
4. If still crashes, force-quit and reboot phone
...
4. Mark arrived as soon as possible
5. Work at normal pace
...
**Your goal:** Complete all stops in your route on time, safely, and professionally.
