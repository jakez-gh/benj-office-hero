...
| WS-10 | done | UI-02/03/04/05: Tenants table scroll + Vehicles/Users add buttons + empty-state CTAs | `apps/admin-web/src/pages/` |
| WS-11 | done | UI-06/07: Standardise error presentation + Operator Dashboard retry button | `apps/admin-web/src/pages/` |
| WS-12 | done | UI-08/09/10: Button label consistency, suppress onboarding on operator pages, forgot-password link | `apps/admin-web/src/` |
